...
export default function Home() {
  return (
    <main className="overflow-y-scroll pl-2 h-screen">
      <Header />
      <Card />
      <section className="flex flex-col xl:flex-row gap-6 sm:gap-6 md:gap-8 lg:gap-6 xl:gap-[2%] pr-6 sm:pr-7 md:pr-6 lg:pr-7 xl:pr-0 2xl:pr-1 box-border pl-2">
